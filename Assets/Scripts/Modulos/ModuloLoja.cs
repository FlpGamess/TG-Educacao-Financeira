...
{   [Header("Paginas")]
    ...
    [Header("Containers")]
    //containers vulgo lugares onde v�o ficar cada coisa
    public Transform containerBotoes;
    public Transform containerItens;

    [Header("Variaveis Sele��o")]
    ...
    public void CarregarLoja()
    {
        ...
        {
            //cria um bot�o atraves do preFabBotao no containerBotoes
            botao = Instantiate(preFabBotao, containerBotoes);
            //se a lista de bot�es da loja n�o tiver esse bot�o e ele existir
            if (!botoes.Contains(botao) && botao)
            {
                //executa a configura��o do bot�o mandando ele,o texto e a fun��o
                ...
                //adiciona o bot�o na lista de bot�es
                botoes.Add(botao);
            }
        }
        ...
        List < (string, string) > infos = new List<(string, string)>
            {
                ...
                ("Descri��o", itemSelecionado.Descricao),
                ("Pre�o", $"R$ {itemSelecionado.Preco}"),
    ...
    //vou deletar isso no futuro, relaxa, � s� pra aparecer uma mensagem pra entender que ta funcionando 
    //o click no botao
